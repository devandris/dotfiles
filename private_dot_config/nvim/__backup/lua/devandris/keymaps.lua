...
-- Telescope
key_map("n", "<leader>fa", ":Telescope find_files<CR>")
key_map("n", "<leader>ff", ":Telescope git_files<CR>")
key_map("n", "<leader>rg", ":Telescope live_grep<CR>")
key_map("n", "<leader>gb", ":Telescope git_branches<CR>")
key_map("n", "<leader>fb", ":Telescope buffers<CR>")
key_map("n", "<leader>vc", ":Telescope git_bcommits<CR>")
key_map("n", "<leader>vC", ":Telescope git_commits<CR>")
key_map("n", "<leader>vs", ":Telescope git_stash<CR>")
key_map("n", "<leader>gs", ":Telescope git_status<CR>")
key_map("n", "<leader>vd", ":Telescope diagnostics<CR>")
